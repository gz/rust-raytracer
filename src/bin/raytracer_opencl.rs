...
fn main()
{
    ...
    for i in 0..HEIGHT {
        for j in 0..WIDTH {
            ...
            f.write_all( format!("{} {} {} ", to_int(x), to_int(y), to_int(z)).as_bytes() ).ok();
        }
    }
}
